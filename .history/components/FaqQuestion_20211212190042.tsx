...
Builder.registerComponent(FaqQuestion, {
  ...
  inputs: [
    ...
    },
    {
      name: 'firstAnswer',
      type: 'text',
      defaultValue: "  Please contact us as soon as possible with your order number and email and we will try our best to accomodate your request. Please note that
      some orders may not be cancellable after leaving our warehouse.",
    },
    {
      name: 'secondQuestion',
