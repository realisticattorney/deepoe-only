    ...
    <div className="relative z-0 mt-4  mb-10 classes.my__carousel_main">
      ...
      >
        {carouselProducts.map((i) => (
          ...
          <h2 className="absolute w-6 h-6 z-50 top-1 left-4 font-extralight font-mono rounded-full flex justify-center items-center text-center p-4 mt-1 bg-gray-200">{i.number}</h2>
          </div>
        ))}
      </Carousel>
    </div>
