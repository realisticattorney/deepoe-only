...
const Banner = ({ carouselProducts, selectedItem }) => {
  ...
  useEffect(() => {
//find the equation such that if the window is 329px wide, the slide percentage is 68.7% and that if the window is 368px wide, the slide percentage is 61.415%
