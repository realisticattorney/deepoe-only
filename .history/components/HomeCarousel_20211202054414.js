...
const Banner = ({ carouselProducts, selectedItem }) => {
  ...
  useEffect(() => {
//find the equation based on the following data points: for 329px wide, the slide percentage is 68.7% and for the is 368px wide, the slide percentage is 61.415%
