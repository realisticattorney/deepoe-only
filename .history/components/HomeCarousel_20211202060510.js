...
const Banner = ({ carouselProducts, selectedItem }) => {
  ...
  useEffect(() => {
    ...
    // if (windowSize.width < 310) {
    //   setSlidePercentage(73.143);
    //   return slidePercentage;
    // } else if (windowSize.width < 330) {
    ...
    //   return slidePercentage;
    // } else if (windowSize.width < 438) {
    //   setSlidePercentage(51.8);
    //   return slidePercentage;
    // } else {
