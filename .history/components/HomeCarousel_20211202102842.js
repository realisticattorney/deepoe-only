    ...
    <div className="relative z-0 mt-4  mb-10 classes.my__carousel_main">
      ...
      >
        {/* {carouselProducts.map((i) => ( */}
          <div className="w-53" key={carouselProducts[0].number}>
            <div className="w-w-53 h-66 from-gray-100  ml-2 bottom-0 relative" key={carouselProducts[0].number}>
              <Image
                quality={100}
                loading="lazy"
                objectFit="cover"
          ...
          <div className="w-53" key={carouselProducts[1].number}>
          ...
          <div className="w-53" key={carouselProducts[2].number}>
            <div className="w-full h-66 from-gray-100  ml-2 bottom-0 relative">
              <Image
                quality={100}
                loading="lazy"
