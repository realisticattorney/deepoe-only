...
const HomeCarousel = ({ carouselProducts, selectedItem, setSelectedItem }) => {
  ...
  return (
    ...
    <div className="relative z-0 mt-4  mb-10 classes.my__carousel_main lg:max-w-screen-lg xxl:max-w-screen-xxl hidden lg:block">
      <Carousel
        infiniteLoop
        showStatus={false}
        showThumbs={false}
      ...
      >
        {carouselLong.map((i) => (
          <div
            className="w-53 h-66 from-gray-100  ml-5 bottom-0 relative"
            key={i.number}
          >
            <Image
              quality={100}
