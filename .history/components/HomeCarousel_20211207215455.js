...
const HomeCarousel = ({ carouselProducts, selectedItem, setSelectedItem }) => {
  ...
  return (
    ...
    <div className="relative z-0 mt-4  mb-10 classes.my__carousel_main lg:max-w-screen-lg  hidden lg:block">
      <Carousel
        infiniteLoop
        showStatus={false}
        showThumbs={false}
    ...
    <div className="relative z-0 mt-4  mb-10 classes.my__carousel_main lg:max-w-screen-lg  hidden xxl:block">
      <Carousel
        infiniteLoop
        showStatus={false}
        showThumbs={false}
