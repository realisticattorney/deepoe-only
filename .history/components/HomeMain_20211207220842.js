...
const HomeMain = ({ products, carouselProducts }) => {
  ...
  return (
    <div className="w-full  overflow-hidden xxl:max-w-screen-xxl xxl:min-w-max">
      <div className="relative h-65 xxl:max-w-screen-xxl xxl:min-w-max">
        <Image
          src="/heroHome.jpg"
          layout="fill"
          objectFit="cover"
...
<div className="lg:grid lg:grid-cols-2 lg:max-w-screen-lg xl:mx-auto lg:my-5 lg:px-3">
