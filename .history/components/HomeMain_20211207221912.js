...
const HomeMain = ({ products, carouselProducts }) => {
  ...
  return (
    ...
    <div className="w-screen">
      ...
      <h2 className="text-center w-64 lg:w-130 lg:text-3xl lg:font-extralight mx-auto font-light font-mono text-xl lg:px-20 md:px-0">
        We create and curate designs for your home and our shared one
      </h2>
<div className="lg:grid lg:grid-cols-2 lg:max-w-screen-lg xl:mx-auto lg:my-5 lg:px-3 md:max-w-screen-md">
      <div className="px-6 my-6 mt-10 lg:pr-0">
        <div className="w-full  overflow-hidden">
