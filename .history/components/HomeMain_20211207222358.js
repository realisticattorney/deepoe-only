...
<div className="lg:grid lg:grid-cols-2 lg:max-w-screen-lg xl:mx-auto lg:my-5 lg:px-3 md:w-145 md:px-6 md:mx-auto">
      ...
      <div className=" mx-6 md:mr-0 mb-12 md:w-96 md:pl-6 lg:ml-0 w-96">
        <h2 className="text-center w-full font-light leading-6 lg:text-left md:mt-12  font-mono text-lg">
