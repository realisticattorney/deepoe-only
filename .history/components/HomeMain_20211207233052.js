  ...
  return (
    <div className="w-full  overflow-hidden">
      <div className="relative h-65">
        ...
        />
        <h2
          className={`fivexs:text-2xl xxs:text-6xl text-3xl md:text-4xl lg:text-6xl text-white absolute left-0 right-0 ml-auto mr-auto top-16 italic font-medium w-80 md:w-96 lg:w-145 mb-6 text-center 
            `}
        >
