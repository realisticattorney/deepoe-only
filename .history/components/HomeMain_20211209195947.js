    ...
    <div className="w-full  overflow-hidden">
      ...
      <div className="lg:grid lg:grid-cols-2 lg:max-w-screen-lg  mx-6 lg:mb-4 lg:w-145 lg:px-4 lg:mx-auto">
        ...
        <div className="w-full mx-auto">
          <h2 className="text-center w-full font-light zero:w-80 fourxs:w-96 xxxs:w-102  xxs:w-105 xxs2:w-107 xs:mx-auto leading-6 lg:text-left lg:mt-14  font-mono text-lg lg:pl-10 lg:pr-7">
