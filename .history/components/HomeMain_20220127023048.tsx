...
export const HomeMain = ({ products, carouselProducts }: HomeProps) => {
  ...
  return (
    <div className="w-full  overflow-hidden">
      <div className="relative h-65">
        ...
        <a href={`https://deepoe-only.vercel.app/collections/frontpage`} rel="noreferrer">
      ...
      <div className="lg:grid lg:grid-cols-2 lg:max-w-screen-lg  mx-6 lg:mb-4 lg:w-145 lg:px-4 lg:mx-auto">
        ...
        <div className="w-full mx-auto">
          <h2 className="text-center w-full font-light xs:w-96 xs:mx-auto leading-6 lg:text-left lg:mt-14  font-mono text-lg lg:pl-10 lg:pr-7">
            What’s a sustainable good? At deepoe, we see sustainability as an
            ongoing process and a daily challenge. We’re on a journey as we try,
            with each product and package, to reduce our footprint, increase our
            knowledge, and head towards a better future.
          </h2>
...
Builder.registerComponent(HomeMain, { name: 'HomeMain' });
