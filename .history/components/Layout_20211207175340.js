...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-deepoe-cream  xl:mx-auto">
      <Script
        async
      ...
      ></Script>
      <Nav />
      <main className="h-full flex-grow overflow-scroll xl:max-w-screen-xl  xl:overflow-y-auto ">{children}</main>
      {/* {router.pathname !== '/' && ( */}
