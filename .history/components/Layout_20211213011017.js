      ...
      <footer className=" text-white h-72 text-sm font-extralight font-mono grid col-span-3 grid-cols-3 grid-rows-2 p-5 bg-deepoe-chocolate">
        <div className="inline-flex col-span-1 row-span-1 ">
          <ul className="flex-col space-y-1.7 ">
            <li>
              <a href="https://www.instagram.com/shopdeepoe/" target="_blank" rel="noreferrer">
                Instagram
              </a>
            </li>
            <li>
              <a href="www.pinterest.com/shopdeepoe" target="_blank" rel="noreferrer">
                Pinterest
              </a>
            </li>
            <li>
              <a href="https://www.facebook.com/shopdeepoe" target="_blank"  rel="noreferrer">
                Facebook
              </a>
            </li>
            <li>
              <a href="www.tiktok.com/@shopdeepoe" target="_blank" rel="noreferrer">
                Tik Tok
              </a>
            </li>
            <li>
              <a href="https://twitter.com/shopdeepoe" target="_blank" rel="noreferrer">
                Twitter
              </a>
            </li>
          </ul>
