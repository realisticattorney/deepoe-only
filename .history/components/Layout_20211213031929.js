...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-deepoe-cream  ">
      ...
      <footer className=" text-white  text-sm font-extralight font-mono  p-5 bg-deepoe-chocolate justify-items-center">
      <div className='grid col-span-3 grid-cols-3 grid-rows-2 h-72 md:max-w-3xl'>
