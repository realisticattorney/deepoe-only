...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-deepoe-cream  ">
      ...
      <footer className=" text-white w-full  text-sm font-extralight font-mono  p-5 bg-deepoe-chocolate">
      <div className='grid col-span-3 grid-cols-3 grid-rows-2 h-72 lg:max-w-3xl justify-self-center'>
