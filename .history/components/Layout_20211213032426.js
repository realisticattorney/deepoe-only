...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-deepoe-cream  ">
      ...
      <div className='grid col-span-3 grid-cols-3 grid-rows-2 h-72 lg:max-w-4xl md:mx-auto md:max-w-2xl md:grid-rows-1'>
        ...
        <div className="flex-col text-xs self-end -mb-2 row-span-2 md:row-span-1">
        ...
        <div className="self-end row-span-2 md:row-span-1">
