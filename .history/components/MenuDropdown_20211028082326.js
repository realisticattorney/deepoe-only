                    ...
                    >
                      <Disclosure.Panel className="text-gray-500 font-light">
                        <ul className="space-y-2 pl-11 mb-6">
                          <Link href><li>Shop All</li></Link>
                          <Link href><li>Dishware</li></Link>
                          <Link href><li>Linens & Towels</li></Link>
                          <Link href><li>Rugs</li></Link>
                          <Link href><li>Furniture</li></Link>
                          <Link href><li>Miscellaneous</li></Link>
                        </ul>
                      </Disclosure.Panel>{' '}
                      {/* <Transition
