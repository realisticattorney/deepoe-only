                    ...
                    >
                      <Disclosure.Panel className="text-gray-500 font-light">
                        <ul className="space-y-2 pl-11 mb-6">
                          <Link href={`/c`}><li>Shop All</li></Link>
                          <Link href={`/c`}><li>Dishware</li></Link>
                          <Link href={`/c`}><li>Linens & Towels</li></Link>
                          <Link href={`/c`}><li>Rugs</li></Link>
                          <Link href={`/c`}><li>Furniture</li></Link>
                          <Link href={`/c`}><li>Miscellaneous</li></Link>
                        </ul>
                      </Disclosure.Panel>{' '}
                      {/* <Transition
