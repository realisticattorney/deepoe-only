                    ...
                    >
                      <Disclosure.Panel className="text-gray-500 font-light">
                        <ul className="space-y-2 pl-11 mb-6">
                          <Link href={`/collections/rontpage`}><li>Shop All</li></Link>
                          <Link href={`/collections/`}><li>Dishware</li></Link>
                          <Link href={`/collections/`}><li>Linens & Towels</li></Link>
                          <Link href={`/collections/`}><li>Rugs</li></Link>
                          <Link href={`/collections/`}><li>Furniture</li></Link>
