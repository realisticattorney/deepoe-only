                      ...
                      <Disclosure.Panel className="text-gray-500 font-light">
                        <ul className="space-y-2 pl-11 mb-6">
                          <Link href={`/collections/frontpage`}>
                            <a onClick={() => setCartOpen(false)}>Shop All</a>
                          </Link>
                          <Link href={`/collections/dishware`}>
                            <a onClick={() => setCartOpen(false)}>Dishware</a>
                          </Link>
                          <Link href={`/collections/towels`}>
                            <a onClick={() => setCartOpen(false)}>Linens & Towels</a>
                          </Link>
                          <Link href={`/collections/rugs`}>
                            <a onClick={() => setCartOpen(false)}>Rugs</a>
                          </Link>
                          <Link href={`/collections/furniture`}>
                            <a onClick={() => setCartOpen(false)}>Furniture</a>
                          </Link>
                          <Link href={`/collections/miscellaneous`}>
                            <a onClick={() => setCartOpen(false)}>Miscellaneous</a>
                          </Link>
                        </ul>
                      </Disclosure.Panel>{' '}
                      {/* <Transition
