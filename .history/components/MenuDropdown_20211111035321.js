        ...
        <div className="absolute  inset-0 overflow-hidden">
          ...
          <div className="fixed inset-y-0 top-20 left-0 pr-0 max-w-full flex">
            <Transition.Child
              ...
              leaveTo="-translate-x-full"        // onClick={() => {
                      //   setOpen(!open);
                      // }}
            >
              <div className="w-screen max-w-md">
                <div className="h-full flex flex-col bg-deepoe-cream shadow-xl overflow-y-scroll">
                  <Disclosure>
                    <Disclosure.Button>
                      <div className="py-6 overflow-y-auto space-y-6 mt-7 px-6 sm:px-6 focus:outline-none active:outline-none active:no-underline">
