                  ...
                  {cart.length > 0 ? (
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      ...
                      <div className="mt-6">
                        <a
                          href={checkoutUrl}
                          className="flex justify-center items-center px-6 py-3 border border-transparent shadow-sm text-base font-medium text-white bg-deepoe-chocolate hover:bg-gray-800"
                        >
                          Checkout
                        </a>
                      </div>
