                  ...
                  {cart.length > 0 ? (
                    <div className="px-4 sm:px-6 font-public-sans-normal">
                      ...
                      <div className="mt-5">
                        <a
                          href={checkoutUrl}
                          className="flex justify-center items-center px-6 py-1.5 border border-transparent shadow-sm text-xl font-base text-white bg-deepoe-chocolate hover:bg-gray-800 font-sans"
                        >
                          Checkout
                        </a>
                      </div>
