...
import { XIcon, TrashIcon, MinusIcon, PlusIcon } from '@heroicons/react/outline';
...
export default function MiniCart({ cart }) {
  ...
  const { cartOpen, setCartOpen, checkoutUrl, removeCartItem, addToCart,subtractCartItem } =
                            ...
                            {cart.map((product) => (
                              <li key={product.id} className="py-4 flex ">
                                ...
                                <div className="ml-3.5 flex-1 flex flex-col">
                                  ...
                                  <button><MinusIcon className="h-5 w-5" /></button>
                                  ...
                                  <button><PlusIcon className="h-5 w-5" /></button>
                                    ...
                                    <div className="flex flex-grow-0 text-xs font-public-sans-normal">
