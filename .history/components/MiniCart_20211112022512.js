                          ...
                          >
                            {cart.map((product) => (
                              <li key={product.id} className="py-4 flex ">
                                <div className="relative flex-shrink-0 w-28 h-32 border border-gray-200 overflow-hidden">
                                  <Image
                                    src={product.image}
                                    alt={product.title}
                                    layout="fill"
                                ...
                                <div className="ml-3.5 flex-1 flex flex-col -mb-2">
                                  <div>
                                  ...
                                  <div className="flex-1 flex items-end justify-between text-sm font-light pl-1">
                                    <div className="flex space-x-2">
                                      ...
                                      <p className="text-gray-900 text-xl font-mono">
