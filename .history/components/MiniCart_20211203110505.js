                          ...
                          <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
                            <div>
                              ...
                              <input
                                ...
                                className={`block w-full border shadow-sm  min-w-min bg-deepoe-cream text-sm font-light font-mono  py-0.5 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-2 ${
