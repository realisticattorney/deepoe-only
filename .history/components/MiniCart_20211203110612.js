                  ...
                  {cart.length > 0 ? (
                    <div className="px-4 sm:px-6 font-mono ">
                      ...
                      <div className="mt-5 mb-32">
                        <a
                          href={checkoutUrl}
                          className="flex justify-center items-center px-6 py-1 border border-transparent shadow-sm text-2xl font-base text-white bg-deepoe-chocolate hover:bg-gray-800 font-sans"
                        >
                          Checkout
                        </a>
                      </div>
