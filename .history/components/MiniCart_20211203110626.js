                      ...
                      <div className="pt-4 border-t border-gray-900 space-y-1.5 flex-col  text-gray-900">
                        ...
                        <div className="flex  underline">
                          <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
                            ...
                            <button
                              type="submit"
                              className=" w-full inline-flex justify-center py-0 px-6 border border-transparent shadow text-base   text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
                            >
                              Apply
                            </button>
                          </form>
