                  ...
                  {cart.length > 0 ? (
                    <div className="px-4 sm:px-6 font-mono ">
                      <div className="pt-4 border-t border-gray-900 space-y-1.5 flex-col  text-gray-900">
                        ...
                        <div className="flex justify-self-stretch  underline">
                          <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
                            <div>
                              ...
                              <input
                                ...
                                className={`block w-full border shadow-sm  min-w-max flex-grow bg-deepoe-cream text-sm font-light font-mono  py-1 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-2 ${
