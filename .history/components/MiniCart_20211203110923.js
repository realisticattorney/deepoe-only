                          ...
                          >
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full max-w-full border shadow-sm  min-w-max flex-grow bg-deepoe-cream text-sm font-light font-mono  py-1 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-2 ${
