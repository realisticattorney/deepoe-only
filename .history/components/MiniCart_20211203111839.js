                          ...
                          >
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full border-2 border-deepoe_default-black shadow-sm  min-w-max  bg-deepoe-cream text-base git  font-light font-mono  py-1 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate focus:outline-none focus:ring-2 ${
