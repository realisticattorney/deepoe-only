  ...
  return (
    <header className="sticky top-0  bg-deepoe-cream z-50">
      <div className="flex items-center justify-between max-w-6xl pt-14 pb-2 px-4 mx-auto">
        {!parentState ? (
          <a
            className="cursor-pointer font-public-sans-light"
          ...
          <p className="cursor-pointer font-public-sans-light">close</p>
        )}
        <MenuDropdown
        ...
        {!cartOpen ? (
          <a
            className="cursor-pointer text-sm font-public-sans-light"
