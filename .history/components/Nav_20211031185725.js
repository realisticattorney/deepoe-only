  ...
  return (
    <header className="sticky top-0  bg-deepoe-cream z-50">
      <div className="flex items-center justify-between max-w-6xl pt-14 pb-2 px-5 mx-auto">
        {!parentState ? (
          <a
            className="cursor-pointer font-public-sans-normal font- text-gray-700 text-sm"
          ...
          <p className="cursor-pointer font-public-sans-normal font- text-gray-700 text-sm">
            close
          </p>
        )}
        <MenuDropdown
        ...
        {!cartOpen ? (
          <a
            className="cursor-pointer text-sm font-public-sans-normal font- text-gray-700"
            onClick={() => setCartOpen(!cartOpen)}
          >
            cart ({cartQuantity})
          </a>
        ) : (
          <p className="cursor-pointer text-sm font-public-sans-normal font- text-gray-700">
            close
          </p>
        )}
