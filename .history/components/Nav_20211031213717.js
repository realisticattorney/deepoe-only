  ...
  return (
    <header className="sticky top-0  bg-deepoe-cream z-50">
      <div className="flex items-center justify-between max-w-6xl pt-9 pb-2 px-5 mx-auto">
        {!parentState ? (
          <a
            className="cursor-pointer font-public-sans-normal font-medium text-gray-700 "
          ...
          <p className="cursor-pointer font-public-sans-normal font-medium text-gray-700 ">
            close
          </p>
        )}
        <MenuDropdown
