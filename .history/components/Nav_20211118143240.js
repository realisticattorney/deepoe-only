    ...
    <header className="sticky top-0  bg-deepoe-cream z-50 border-b ">
      ...
      <div className="w-12 pl-1">
        {!parentState && !cartOpen ? (
          ...
          <p className={`cursor-pointer pt-1.5 font-public-sans-normal font-extralight ${!parentState ? `` : 'font-normal'}`}>
        ...
        {!cartOpen && !parentState ? (
          <a
            className="cursor-pointer pt-1.5  font-public-sans-normal  font-extralight"
            onClick={() => {
