    ...
    <header className="sticky top-0  bg-deepoe-cream z-50 border-b ">
      ...
      <div className="w-12 pl-1">
        {!parentState && !cartOpen ? (
          <a
            className="cursor-pointer font-mono pt-1  font-extralight"
          ...
          <p className={`cursor-pointer pt-1 font-mono font-extralight ${!parentState ? `` : 'font-normal'}`}>
        ...
        {!cartOpen && !parentState ? (
          <a
            className="cursor-pointer  font-mono  font-extralight"
            onClick={() => {
          ...
          <p className="cursor-pointer pt-1 font-mono  font-extralight">
