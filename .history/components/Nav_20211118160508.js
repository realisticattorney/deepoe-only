      ...
      <div className="flex items-center justify-between max-w-6xl pt-9 pb-2 px-5 mx-auto">
        <div className="w-12 pl-1">
          {!parentState && !cartOpen ? (
            <a
              className="cursor-pointer font-mono text-base pt-1  font-extralight"
            ...
            <p
              className={`cursor-pointer pt-1 font-mono text-base font-extralight ${
        ...
        <div className="w-14">
          {!cartOpen && !parentState ? (
            <a
              className="cursor-pointer  font-mono text-base  font-extralight ${
                !parentState ? `` : 'font-normal pt-0'
              }`}
              onClick={() => {
            ...
            <p className="cursor-pointer pt-1 font-mono text-base  font-extralight">
