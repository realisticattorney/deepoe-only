      ...
      <div className="absolute z-0">
        ...
        />
          ...
          {!parentState && !cartOpen ? (
            <a
              className="cursor-pointer font-mono text-lg z-40   font-extralight"
            ...
            <p
              className={`cursor-pointer font-mono text-lg z-50 font-extralight ${
