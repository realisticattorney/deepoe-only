...
const ProductForm = ({ product }) => {
  ...
  function setOptions(name, value) { //this function will be called every time the user changes the selected option (onChange, the ProductOptions component) and will update the selectedOptions state
