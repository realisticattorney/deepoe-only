...
const ProductForm = ({ product }) => {
  ...
  return (
    <div className="flex-col flex w-full pt-1">
      ...
      <h3 className={`text-right texts ${selectedVariant.currentlyNotInStock ? "text-red-700" : "text-gray-700"}`}>{selectedVariant.currentlyNotInStock ? "Currently out of stock" : "In Stock"}</h3>
      </div>
