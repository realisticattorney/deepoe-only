    ...
    <div className="flex-col flex w-full pt-1 font-public-sans-normal ">
      ...
      <div>
        ...
        {product.options.map(({ name, values }) => (
          ...
          <div className="text-xs font-light mb-2.5 mt-0.5 space-y-2">
        ...
        <button
          ...
          className="bg-deepoe-chocolate text-white px-2 py-2 my-1 text-2xl  w-full hover:bg-gray-800 font-sans"
        >
          Add to Cart
        </button>
      </div>
