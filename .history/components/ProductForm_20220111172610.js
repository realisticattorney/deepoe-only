        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate lg:col-end-2 lg:col-start-2">
          ...
          <Accordion className=" shadow-none bg-deepoe-cream  border-b border-deepoe_default-black ">
            <AccordionSummary
              ...
              id="panel2a-header"
              className="flex px-0 max-h-0 justify-between text-lg font-extralight items-center text-left text-deepoe_default-black"
            >
              <p className="truncate font-mono font-extralight text-lg2">
            ...
            <AccordionDetails>
              <div className=" overflow-hidden duration-300 text-sm  group-focus:pb-2 font-mono  text-left font-extralight border-deepoe_default-black">
                <ul className="list-disc list-outside font-mono font-extralight ">
                  {itemsSpecs2.map((item, index) => (
                    <li key={index} className="">
