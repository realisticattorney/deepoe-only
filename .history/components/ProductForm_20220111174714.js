      ...
      <div className="lg:col-start-2 lg:col-end-2 lg:mt-8">
        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate lg:col-end-2 lg:col-start-2">
          ...
          <Accordion className=" shadow-none bg-deepoe-cream border-b border-deepoe_default-black">
            ...
            >
              <p className="truncate font-mono font-extralight text-lg2">
                Details
              </p>
            </AccordionSummary>
            <AccordionDetails>
          ...
          <Accordion className="p-0 shadow-none bg-deepoe-cream  border-b border-deepoe_default-black ">
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="panel2a-content"
              id="panel2a-header"
              className="flex p-0 max-h-0 justify-between text-lg font-extralight items-center text-left text-deepoe_default-black"
            >
              <p className="truncate font-mono font-extralight text-lg2 py-0 my-0">
