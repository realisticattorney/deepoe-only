      ...
      <div className="lg:col-start-2 lg:col-end-2 lg:mt-8">
        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate lg:col-end-2 lg:col-start-2">
          ...
          <Accordion className="p-0 m-0 shadow-none bg-deepoe-cream  border-b border-deepoe_default-black ">
            ...
            <AccordionDetails>
            <div className="overflow-hidden duration-300  text-sm  group-focus:py-2 font-mono  group-focus:max-h-72  text-left font-extralight  border-b border-deepoe_default-black">
              <p className="mb-1">{details}</p>
            </div>
            </AccordionDetails>
          </Accordion>
