      ...
      <div className="lg:col-start-2 lg:col-end-2 lg:mt-8">
        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate lg:col-end-2 lg:col-start-2">
          ...
          >
            ...
            <AccordionDetails
              sx={{<div class="MuiAccordionDetails-root css-1szmjxe-MuiAccordionDetails-root"><div class="mx-0 overflow-hidden  text-sm   font-mono  text-left font-extralight border-deepoe_default-black"><ul class="list-disc list-outside font-mono font-extralight "><li class=""><span class="px-1 text-base font-black">•</span> <!-- --> Plates come in a matching set of 4</li><li class=""><span class="px-1 text-base font-black">•</span> <!-- -->Each plate is 9.85” in diameter</li><li class=""><span class="px-1 text-base font-black">•</span> <!-- -->Hand wash before use </li><li class=""><span class="px-1 text-base font-black">•</span> <!-- -->Dishwasher safe</li><li class=""><span class="px-1 text-base font-black">•</span> <!-- -->Do not microwave </li><li class=""><span class="px-1 text-base font-black">•</span> <!-- -->Do not leave in water: towel dry and set vertically after use or after taking from dishwasher.</li></ul></div></div>
                margin: '0',
