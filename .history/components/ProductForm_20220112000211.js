      ...
      <div className="lg:col-start-2 lg:col-end-2 lg:mt-8">
        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate lg:col-end-2 lg:col-start-2">
          ...
          >
            ...
            <AccordionDetails>
              <div className="text-sm  font-mono  text-left font-extralight  ">
                <p className="mb-1">{details}</p>
              </div>
            </AccordionDetails>
          </Accordion>
          <Accordion
            // className="py-0  m-0 shadow-none bg-deepoe-cream  border-b border-deepoe_default-black"
            // sx={{
            //   margin: '0px',
            //   pardding: '0px',
            //   minHeight: 'auto',
          ...
          >
            ...
            <AccordionDetails>
              <div className="mx-0 py-0 overflow-hidden  text-sm   font-mono  text-left font-extralight border-deepoe_default-black">
                <ul className="list-disc list-outside font-mono font-extralight ">
                  {itemsSpecs2.map((item, index) => (
                    <li key={index} className="">
