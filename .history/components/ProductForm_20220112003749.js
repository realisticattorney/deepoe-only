  ...
  <MuiAccordionSummary
    expandIcon={
      this.state.expanded[statIndex] ? (
        <RemoveIcon onClick={this.handleToggleOne(statIndex)} sx={{ fontSize: '1.2rem', marginRight: '0px', paddingRight: '0px' }}/>
      ) : (
        <AddIcon onClick={this.handleToggleOne(statIndex)} sx={{ fontSize: '1.2rem', marginRight: '0px', paddingRight: '0px' }}/>
      )
    }
    {...props}
  />
