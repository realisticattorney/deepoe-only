...
const ProductList = ({ collection, products }) => {
  return (
    <div className=" w-full   overflow-hidden min-w-full">
      <div className="relative h-60 min-w-full">
        <Image
      ...
      <div className="px-6 pt-6 xl:px-6 min-w-full">
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 xl:grid-cols-2 min-w-full">
