              ...
              {name === 'Color' ? (
                ...
                >
                  <div
                    ...
                    {...(value == variantsHexArray2[2]?.variantColor ? { style: { backgroundColor: `#${variantsHexArray2[3]?.hex}` } } : null)}
                    ...
                    {...(value == variantsHexArray2[6]?.variantColor ? { style: { backgroundColor: `#${variantsHexArray2[6]?.hex}` } } : null)}
                  ></div>
                </div>
              ) : null}
              {name === 'Size' ? (
