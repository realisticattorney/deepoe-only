        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate">
          ...
          <button className="group focus:outline-none">
            ...
            <div className="max-h-0 overflow-hidden duration-300 text-sm  group-focus:max-h-40  text-left font-extralight text-gray-500 border-b border-gray-700">
              9.85” in diameter (25cm) Non-toxic and compostable Composed of
              bamboo fiber and corn starch and printed with food grade ink BPA,
              PVC and Phthalates free General Care Do not microwave Handwash
              before use Dishwasher safe Avoid soaking in water for prolonged
              times Suitable for hot foods Store in cool and dry place Set of 4
            </div>
          </button>
          <button className="group focus:outline-none">
