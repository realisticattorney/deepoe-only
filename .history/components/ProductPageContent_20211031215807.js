    ...
    <div>
      ...
      <div className="flex flex-col justify-between items-center space-y-2 max-w-6xl w-11/12 px-2 mx-auto">
        ...
        <div className="flex flex-col w-full py-5 font-public-sans-normal">
          ...
          <p className="text-left text-xs">Sustainability should not be dull, muted, or monotone. We believe sustainabile choices should be designed for impact and bring joy and smiles. Our bamboo plate avoid plastics and melamines and are crafted from renewable bamboo and cornstarch</p>
        </div>
      </div>
    </div>
  );
