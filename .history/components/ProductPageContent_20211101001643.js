      ...
      <div className="flex flex-col justify-between items-center space-y-2 max-w-6xl w-11/12 px-2 mx-auto">
        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate">
          <button className="group focus:outline-none" onClick={handleShow}>
            ...
            <div className="max-h-0 overflow-hidden duration-300   group-focus:py-2 font-public-sans-normal  group-focus:max-h-50  text-xs text-left font-extralight  border-b border-gray-700">
              ...
              <br></br>
              <br></br>
              Our plates are completely free of plastics and
              made from bamboo, cornstarch, and use food-grade inks. They are
              bio-degradable, dishwasher safe, lightweight, and durablly built
              for seasons of use. These plates don’t just replace your outdoor
              styrofoam and plastic options, they’re sturdy and stylish enough
              to belong on your dinner table.
            </div>
          </button>
