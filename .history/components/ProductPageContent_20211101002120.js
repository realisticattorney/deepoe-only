      ...
      <div className="flex flex-col w-full py-5 font-public-sans-normal">
        ...
        <div className="pt-2.5 self-center">
          <Link href={`deepoe/faq`}>
            <button
              type="submit"
              className="inline-flex justify-center py-1 px-10 border border-transparent font-sans shadow text-xl font-light text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              Learn More
            </button>
          </Link>
