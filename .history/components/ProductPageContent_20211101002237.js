    ...
    <div>
      ...
      <div className="flex flex-col w-full py-5 font-public-sans-normal">
        <div className="py-3.5">
          <h2 className="text-left text-2xl pb-1 px-5 font-mono font-normal">Sustainable Style</h2>
        ...
        <div className="py-3.5 bg-deepoe-chocolate">
          <h2 className="text-left text-2xl pb-1 px-5 font-mono font-normal font-light text-white">
            Function First
          </h2>
        ...
        <div className="py-3.5">
          <h2 className="text-left text-2xl pb-1 px-5 font-mono font-normal">Conscious Commerce</h2>
          <p className="text-left text-xs font-light pt-1 px-5">
