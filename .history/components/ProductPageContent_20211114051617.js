...
const ProductPageContent = ({ collection, product }) => {
  ...
  return (
    <div>
      ...
      also, when I add the "yotpo bottomLine div to have the star rating without the other div "yotpo yotpo-main-wdiger
      
      
      {/* <div
        className="yotpo bottomLine"
        data-yotpo-product-id={`Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MTg4NjE4NDA0NjgwOQ`}
        data-url={`/collections/${collection}/${product.handle}`}
      ></div> */}
