    ...
    <div>
      <div className="px-5 pb-3.5 pt-1 z-0">
        <Link href={`/collections/${collection}/`}>
          <a className="text-left pl-1 font-medium font-mono text-lg  text-gray-800">
            {'<'} back to {collection}
          </a>
        </Link>
      </div>
      ...
      <div className="flex flex-col justify-between items-center space-y-2 max-w-6xl w-11/12 px-2 mx-auto">
        ...
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate">
          <button className="group focus:outline-none" onClick={handleShow}>
            <div className="flex justify-between pb-2 pt-0.5 text-lg font-extralight items-center text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75  border-gray-700 ">
              <span className="truncate text-lg font-extralight group-focus:font-light text-lg2">
                Details
              </span>
          ...
          <button className="group focus:outline-none">
            <div className="flex justify-between py-2 text-lg font-extralight text-left items-center text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75  border-gray-700 ">
              <span className="truncate font-mono font-extralight group-focus:font-light text-lg2">
                Item Specifications
              </span>
              <p className="font-thin text-3xl group-focus:hidden">+</p>
