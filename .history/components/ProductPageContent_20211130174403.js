            ...
            >
              ...
              <Link href={`/reviews/${product.handle}`}>
                <button
                  ...
                  className="inline-flex justify-center py-1 px-10 mt-2 font-mono font-lightq border border-transparent shadow text-xl font-light text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
                >
                  More Reviews
                </button>
              </Link>
