  ...
  return (
    <div className={`sm:max-w-2xl mx-auto lg:max-w-xxl lg:grid lg:grid-cols-2 xxl:px-6`}>
      ...
      <div className="flex flex-col w-full lg:col-span-2 font-mono">
        ...
        <div className="px-6 my-6 mt-5 lg:mt-12 xxl:mt-32 lg:px-16 xxl:px-24">
        ...
        <div className="pt-2.5 self-center">
          <Link href={`/deepoe/sustainability`}>
            <button
              type="submit"
              className=" text-sm  font-extralight text-center mt-5 mb-7 w-40 underline font-mono focus:outline-none focus:ring-2 focus:ring-offset-2 lg:text-lg lg:mb-12"
            >
              Learn More
            </button>
          </Link>
