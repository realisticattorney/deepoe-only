      ...
      <div className="flex flex-col justify-between items-center space-y-2 max-w-6xl w-11/12 px-2 mx-auto">
        <div className="flex flex-col w-full border-t pt-2 border-deepoe-chocolate">
          ...
          <button className="group focus:outline-none">
            ...
            >
              <div className="flex flox-col justify-between py-2 font-extralight text-left text-lg text-gray-900 items-center focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75  border-gray-700 group-focus:font-medium">
