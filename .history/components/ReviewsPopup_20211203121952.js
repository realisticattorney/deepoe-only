...
export default function ReviewsPopup({
  ...
  return (
    <Popover as={Fragment} show={openReview} >
      {({ parentReviewState }) => (
        <>
        <Dialog
          ...
          <Popover.Panel static className="absolute ">
            <div className="absolute inset-0 overflow-hidden">
              <Transition.Child
                ...
                leaveTo="opacity-0"
              >
                <div className=" z-50 inset-0 fixed bg-gray-500 bg-opacity-75 transition-opacity" />
              </Transition.Child>
              ...
              >
                <div className="bg-deepoe-cream w-full h-screen md:max-w-md    z-50 fixed inset-y-0 top-0 left-0 right-0 bottom-0 max-w-full  overflow-y-scroll">
