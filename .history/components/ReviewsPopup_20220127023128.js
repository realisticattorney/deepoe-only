...
export default function ReviewsPopup({
  ...
  return (
    <Popover as={Fragment}>
      <Popover.Button
        className={`inline-flex justify-center border-b leading-tight  border-deepoe_default-black  mt-4 mb-7 font-mono font-extralight  text-xl  text-deepoe_default-black  focus:outline-none active:outline-none  focus:ring-0 ${
      ...
      <Popover.Overlay className="fixed inset-0 overflow-hidden " as="div" />
      <Popover.Panel static className="absolute ">
        <div className="absolute inset-0 overflow-hidden">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="z-10  inset-0 fixed bg-gray-500 bg-opacity-75 transition-opacity lalalala overflow-y-auto" />
          </Transition.Child>
          <div className=" z-0 inset-0">
            ...
            >
              <div className="bg-deepoe-cream w-full h-screen md:max-w-md    z-50 fixed inset-y-0 top-0 left-0 right-0 bottom-0 max-w-full  overflow-y-auto">
                <div className=" w-full h-16 bg-deepoe-cream  text-right">
                  <button
                    type="button"
