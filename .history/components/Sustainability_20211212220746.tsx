  ...
  inputs: [
    {
      name: 'copy',
      type: 'string',
      defaultValue: "    What{'`'}s a sustainable good? At deepoe, we see sustainability as an ongoing process and a daily challenge. We’re on a journey as we try, with each product and package, to reduce our footprint, increase our knowledge, and head towards a better future. At Deepoe, are committed to making our products and services as sustainable as possible.",
    },
  ],
});
