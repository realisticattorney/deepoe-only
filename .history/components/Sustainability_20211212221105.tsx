...
const Sustainability = (props: any) => {
  ...
  return (
    <div className=" w-full px-2.5 font-mono">
      <div className="w-full max-w-md  mx-auto bg-deepoe-cream rounded-2xl space-y-5 px-6">
        <h3 className="text-3xl pt-5 py-2 font-thin tracking-tighter">
          Sustainability
        </h3>
        <div>
          <p className="text-base font-thin  leading-8">{props.copy}</p>
        </div>
      </div>
    </div>
  );
