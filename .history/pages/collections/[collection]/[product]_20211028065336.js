...
console.log(pathWithoutFormat[0].params[0])
console.log(pathWithoutFormat[0].params)
console.log(pathWithoutFormat[0].params[2])
console.log(pathWithoutFormat[0].params[3])
console.log(pathWithoutFormat[0].params[4])
console.log(pathWithoutFormat[0].params[5])
console.log(pathWithoutFormat[0].params[6])
