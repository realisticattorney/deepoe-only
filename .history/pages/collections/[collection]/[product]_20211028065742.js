...
export async function getStaticPaths() {
  ...
  var sections = products.map(variant => {
   return variant.node.products.edges.map(val => ({collection: variant.node.handle, product: val.node.handle}))
});
...
console.log(pathWithoutFormat[7].params)
console.log(pathWithoutFormat[8].params)
console.log(pathWithoutFormat[9].params)
console.log(pathWithoutFormat[10].params)
console.log(pathWithoutFormat[12].params)
console.log(pathWithoutFormat[15].params)
