        ...
        >
          <div>
            ...
            <input
              ...
              //   },
              // })}
              className={`block w-full shadow text-xs py-1 px-4 placeholder-gray-500 focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md focus:outline-none focus:ring-2 ${
