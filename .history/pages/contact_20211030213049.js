        ...
        >
          ...
          <div>
            ...
            <input
              ...
              //   },
              // })}
              className={`block w-full border shadow-sm bg-deepoe-cream text-xs font-extralight  py-1 px-4 placeholder-gray-500 focus:ring-blue-500 focus:border-blue-500 border-gray-400 focus:outline-none focus:ring-2 ${
