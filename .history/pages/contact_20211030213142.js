        ...
        >
          <div>
            ...
            <input
              ...
              //   },
              // })}
              className={`block w-full shadow-sm border bg-deepoe-cream text-xs font-extralight py-1 px-4 placeholder-gray-500 focus:ring-blue-500 focus:border-blue-500 border-gray-600 focus:outline-none focus:ring-2 ${
