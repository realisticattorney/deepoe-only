      ...
      <div className="mx-auto w-full max-w-2xl  bg-deepoe-cream py-2">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="inline-flex justify-center py-2.5 px-6 border border-transparent shadow text-base font-medium text-white bg-deepoe-chocolate hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Submit
            </button>
          </div>
