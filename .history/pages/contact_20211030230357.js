    ...
    <div className="flex-col bg-deepoe-cream px-4 sm:px-6 flex">
      ...
      <div className="flex flex-col w-full pt-8">
        ...
        <div className="justify-self-end pt-2.5 self-end">
          <button
            type="submit"
            className="inline-flex justify-center py-1.5 px-6 border border-transparent shadow text-xs font-base text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
          >
            View More
          </button>
        </div>
