        ...
        >
          ...
          <div>
            ...
            <input
              ...
              //   },
              // })}
              className={`block w-full border shadow-sm bg-deepoe-cream text-xs font-extralight  py-1 px-2 placeholder-gray-500 focus:ring- focus:border-blue-500 border-gray-600 focus:outline-none focus:ring-2 ${
