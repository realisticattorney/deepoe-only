    ...
    <div className="flex-col bg-deepoe-cream px-4 sm:px-6 flex">
      ...
      <div className="flex flex-col w-full pt-8">
        ...
        <button className="group focus:outline-none px-3" onClick={handleShow}>
          ...
          <div className="max-h-0 overflow-hidden duration-300 group-focus:py font-public-sans-normal group-focus:max-h-40  text-xs text-left font-extralight text-gray-500 border-b border-gray-700">
