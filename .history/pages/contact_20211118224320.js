      ...
      <div className="flex flex-col w-full pt-8 font-mono">
        ...
        <div className="justify-self-end pt-2.5 self-end">
          <Link href={`deepoe/faq`}>
            <button
              type="submit"
              className="inline-flex font-sans justify-center py-0.5 px-4 w0 border border-transparent shadow text-sm font-light text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              View More
            </button>
          </Link>
