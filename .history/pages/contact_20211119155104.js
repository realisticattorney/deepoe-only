      ...
      <div className="flex flex-col w-full pt-8 font-mono">
        ...
        <div className="justify-self-end pt-2.5 mt-2 self-end">
          <Link href={`deepoe/faq`}>
            <button
              type="submit"
              className="inline-flex font-sans justify-center py-0.5 text-base px-4 w-36 mb-12 border border-transparent shadowfont-light text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2 active:outline-none"
            >
              View More
            </button>
          </Link>
