...
export default function Contact() {
  ...
  return (
    <div className="flex-col bg-deepoe-cream px-6 sm:px-6 flex mt-20">
      <div className="mx-auto w-full max-w-2xl  bg-deepoe-cream py-2 items-center">
        <h2 className="text-2xl font-thin pt-5 py-2 font-mono tracking-tighter">
      ...
      <div className="flex flex-col w-full pt-8 font-mono">
        <h4 className="text-2xl font-thin pt-5 py-2 font-mono tracking-tighter">
          Or check our{' '}
