    ...
    <div className=" w-full px-4">
      ...
      <h3 className="text-lg font-light">Frequently Asked Questions</h3>
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className={`flex justify-between w-full  py-2 text-sm font-medium text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75 border-b border-gray-700 ${open ?  "border-b" : ""}`}>
