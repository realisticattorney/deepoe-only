      ...
      <div className="w-full max-w-md p-2 mx-auto bg-deepoe-cream rounded-2xl">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button
                className={`flex justify-between w-full  pt-2 text-sm font-medium text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75 border-b border-gray-700 ${
                  open ? 'border-none' : ''
                }`}
              >
