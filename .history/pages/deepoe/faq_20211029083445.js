        ...
        <Disclosure>
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 py-2 text-xs font-extralight text-gray-500 border-b border-gray-700 max-h-0 overflow-hidden duration-300 group-focus:max-h-40">
