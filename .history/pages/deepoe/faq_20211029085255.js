    ...
    <div className=" w-full px-4">
      ...
      <div class="flex flex-col w-full">
        <button class="group focus:outline-none">
          <div class="flex items-center justify-between h-12 px-3 hover:bg-gray-200 text-sm font-medium text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75  border-gray-700">
          ...
          <div class="max-h-0 overflow-hidden duration-300 px-3  group-focus:max-h-40  text-xs text-left font-extralight text-gray-500 border-b border-gray-700">
            Please contact us as soon as possible with your order number and
