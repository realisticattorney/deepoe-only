    ...
    <div className=" w-full px-4">
      ...
      <div class="flex flex-col w-full">
        <button class="group focus:outline-none">
          <div class="flex justify-between py-2 px-4  text-sm font-medium text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75  border-gray-700">
