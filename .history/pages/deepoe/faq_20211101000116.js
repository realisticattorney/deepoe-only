      ...
      <div className="w-full max-w-md  mx-auto bg-deepoe-cream rounded-2xl space-y-5">
        ...
        <div className="flex flex-col w-full">
          ...
          <button
            ...
            onClick={handleShow}
          >
            <div className="flex justify-between py-2 text-sm  items-center text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75   group-focus:font-medium">
            ...
            <div className="max-h-0 overflow-hidden duration-300 group-focus:py-2  group-focus:max-h-40  text-xs text-left font-extralight text-gray-500 border-b ">
