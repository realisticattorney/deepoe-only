      ...
      <div className="w-full max-w-md  mx-auto bg-deepoe-cream rounded-2xl space-y-5">
        ...
        <div className="flex flex-col w-full">
          ...
          <button
            ...
            onClick={handleShow}
          >
            <div className="flex justify-between py-1.5 text-sm  items-center text-left text-gray-900 focus:outline-none focus-visible:ring  focus-visible:ring-opacity-75  border-gray-700 group-focus:font-medium">
