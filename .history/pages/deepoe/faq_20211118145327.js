    ...
    <div className=" w-full px-2.5 font-mono">
      <div className="w-full max-w-md  mx-auto bg-deepoe-cream rounded-2xl space-y-5">
        ...
        <div className="flex flex-col w-full">
          <h4 className="px-3 text-2xl font-light text">Orders</h4>
          <button
        ...
        <div className="flex flex-col w-full pt-5">
          <h4 className="px-3 text-2xl font-light text">Products</h4>
          <button
            className="group focus:outline-none px-3"
            onClick={handleShow}
          >
        ...
        <div className="flex flex-col w-full py-5">
          <h4 className="px-3 text-2xl font-light text">Miscellaneous</h4>
          <button
            className="group focus:outline-none px-3"
            onClick={handleShow}
          >
