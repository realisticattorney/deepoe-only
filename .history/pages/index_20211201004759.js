    ...
    <div className="">
      ...
      <div className="w-full  overflow-hidden">
          <div className="relative h-64">
            ...
            <LinkAll about us, our products and our shop. Read more about the deepoe ecosystem. href={""}>
              <p className="text-white text-sm font-light text-center mb-4 bottom-0 left-0 ml-auto w-40 ">Shop All Products</p>
            </LinkAll>
          </div>
        </div>
