        ...
        <div className="px-6 my-6">
          <div className="w-full  overflow-hidden">
            <div className="relative h-110">
              ...
              />
              <button>
                <p className="text-white text-sm absolute p-5 rounded-full bg-deepoe-tangerine font-light text-center right-0 mr-auto mb-4 bottom-0 left-0 ml-auto w-40 underline font-mono">
                  1
                </p>
              </button>
            </div>
