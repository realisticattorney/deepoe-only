        ...
        <div className="px-6 my-6">
          <div className="w-full  overflow-hidden">
            <div className="relative h-110">
              ...
              />
              <button>
                <p className="text-white text-sm relative p-4 rounded-full   bg-deepoe-tangerine font-light left-40 font-mono">
                  <span className="absolute mx-auto my-auto">1</span>
                </p>
              </button>
            </div>
          </div>
