        ...
        <div className="px-6 my-6">
          <div className="w-full  overflow-hidden">
            <div className="relative h-110">
              ...
              />
              <button>
                <p className="text-white text-sm relative p-5 border-6 border-green-700 rounded-full bg-deepoe-tangerine font-light left-40 font-mono">
                  <span className="relative left-50 top-40">1</span>
                </p>
              </button>
            </div>
          </div>
