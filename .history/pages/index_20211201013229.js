          ...
          <div className="w-full  overflow-hidden">
            <div className="relative h-110">
              <Image
                ...
                objectPosition="top"
              />
              <div class="py-24 flex items-center justify-center bg-gray-700 space-x-8">
                <div class="relative w-12 h-12 bg-gray-700 rounded-full flex justify-center items-center text-center p-5 shadow-xl">
                  1
                </div>
              </div>
            </div>
