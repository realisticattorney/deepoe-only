          ...
          <div className="w-full  overflow-hidden">
            <div className="relative h-110">
              ...
              <div class="py-24 flex items-center justify-center space-x-8">
                <div class="relative w-10 h-10 opacity-40 bg-opacity-50 bg-gray-700  font-mono rounded-full flex justify-center items-center text-center p-5 shadow-xl">
                  <span className="text-white opacity-100">1</span>
                </div>
              </div>
            </div>
          </div>
