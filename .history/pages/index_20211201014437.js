          ...
          <div className="w-full  overflow-hidden">
            <div className="relative h-110">
              ...
              <div class="pt-10 flex items-center justify-center space-x-8">
                <div class="relative w-6 h-6 font-thin  bg-opacity-70 bg-gray-600  font-mono rounded-full flex justify-center items-center text-center p-4 shadow-xl text-white">
                  1
                </div>
              </div>
