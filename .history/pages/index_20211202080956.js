          ...
          <div className="w-full  overflow-hidden">
            <div className="relative ">
              <Image
                ...
                objectPosition="top"
              />
              <div className="h-1/2 flex items-center justify-center space-x-8">
                <button className="" onClick={() => setSelectedItem(1)}>
              ...
              <div className="h-1/2  flex items-center pl-28 justify-center space-x-8">
