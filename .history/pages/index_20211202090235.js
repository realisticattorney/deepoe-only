        ...
        <div className="px-6 my-6">
          <div className="relative  w-full">
            ...
            <button className="absolute p-5" onClick={() => setSelectedItem(1)}>
              <div className="w-6 h-6 font-thin top-0  bg-opacity-60 bg-gray-700  font-mono rounded-full flex justify-center items-center text-center p-4 shadow-xl text-white">
                1
              </div>
            </button>
            {/*
