      ...
      <div className="w-full  overflow-hidden">
        ...
        <div className="px-6 my-6">
          <div className="relative  w-full">
            ...
            <button className="absolute p-5 top-1/4" onClick={() => setSelectedItem(1)}>
              <div className="w-6 h-6 font-thin   bg-opacity-60 bg-gray-700  font-mono rounded-full flex justify-center  text-center p-4 shadow-xl text-white">
                1
              </div>
            </button>
            {/*
