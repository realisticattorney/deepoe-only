      ...
      <div className="w-full  overflow-hidden">
        ...
        <div className="px-6 my-6">
          <div className="relative  w-full">
            ...
            <button
              className="absolute top-3/7 left-1/20 p-40%"
              onClick={() => setSelectedItem(1)}
            >
              <div className="w-1/2 h-1/2 font-thin  bg-opacity-60 bg-gray-700  font-mono rounded-full flex justify-center items-center text-center  shadow-xl text-white">
                1
              </div>
            </button>
            {/*
