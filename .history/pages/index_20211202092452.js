      ...
      <div className="w-full  overflow-hidden">
        ...
        <div className="px-6 my-6">
          <div className="relative  w-full">
            ...
            >
              <div className="w-5 h-6 font-thin p-4 bg-opacity-60 bg-gray-700  font-mono rounded-full flex justify-center items-center text-center  shadow-xl text-white">
                1
              </div>
            </button>
            {/*
