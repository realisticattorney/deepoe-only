        ...
        >
          ...
          <div className="justify-self-end">
            ...
            <Link href="/forgot-password">
               <a className="text-sm  font-mono font-bold  py-0.5 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-2">
                  Forgot Password?
               </a>
            </Link>
        </div>
