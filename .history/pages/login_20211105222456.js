      ...
      <div className="mx-auto w-full max-w-2xl  bg-deepoe-cream py-2 items-center">
        ...
        >
          ...
          <div className="w-full justify-self-stretch">
            <button
              type="submit"
              className="inline-flex justify-center py-1.5 px-f border border-transparent shadow text-base  text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              Log In
            </button>
          </div>
