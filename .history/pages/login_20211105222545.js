      ...
      <div className="mx-auto w-full max-w-2xl  bg-deepoe-cream py-2 items-center">
        ...
        >
          ...
          <div className="w-full justify-self-stretch">
            <button
              type="submit"
              className=" w-full inline-flex justify-center py-1.5 px-6 border border-transparent shadow text-base mx-3  text-white bg-deepoe-chocolate focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              Log In
            </button>
          </div>
