  ...
  return (
    <div className="flex-col bg-deepoe-cream px-4 sm:px-6 flex mt-24 mx-2">
      <div className="mx-auto w-full max-w-2xl  bg-deepoe-cream py-2 items-center">
        ...
        <div className="justify-self-end inline-flex py-0.5 px-1.5">
              <h3 className>
            Don't </h3>
            <Link href="/signup">
              <a className="text-xs  font-mono font-medium placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-2">
                Forgot Password?
              </a>
            </Link>
          </div>
